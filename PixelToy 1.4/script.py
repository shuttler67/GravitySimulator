...
print G*((1.9891*math.pow(10,30)*5.97219 * math.pow(10,24))/ math.pow(149600000000.0,2.0))
...
def gravity(body1Mass,body1Position,body2Mass,body2Position):
	...
	if distance.power > maxdistance:
		...
		print "MAX",maxdistance, body1Position.x, body1Position.y
	if distance.power < mindistance:
		mindistance = distance.power
		print "MIN",mindistance, body1Position.x, body1Position.y
...
bodies = [Body("Earth",152098232000.0,0.0,5.97219*math.pow(10,24),0,29800,63781000.0),Body("Sun",0.0,0.0,1.9891*math.pow(10,30),0.0,0.0,6955000000.0)]
#29951.7
...
while True:
	...
	distanceScaleFactor += (getMouseWheelDelta()/120)/5600000000
	if distanceScaleFactor < 2/560000000:
		distanceScaleFactor = 1/5600000000
