...
bodies = [Body("Planet X",152098232000.0,0.0,5.97219*math.pow(10,24),0,40340,63781000.0),Body("Vega",0.0,6955000000.0,1.9891*math.pow(10,30),-60000,0.0,6955000000.0),Body("Capricorn",0.0,-6955000000.0,1.9891*math.pow(10,30),60000,0.0,6955000000.0)]
